...
HUD ma układ inspirowany interfejsem cRPG: portret, zwarty panel dynamicznych zasobów, aktywna przygotowana broń wraz z aktualnym chwytem, założony pancerz z efektywną odpornością oraz trzy szybkie zestawy I–III. Nad centrum znajdują się pierścienie z bieżącymi wartościami i wyróżnioną postawą. Hover lub fokus broni i pancerza otwiera pełną kartę informacyjną; hover broni przekazuje jawny zasięg do publicznego API Tactical Grid, jeśli moduł jest aktywny.
